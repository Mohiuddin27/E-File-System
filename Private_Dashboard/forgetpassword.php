...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark orange lighten-1">
    <a class="navbar-brand" href="index.html"><img src="js/img/mm.png" width="33px" height="33px"> <font color="##74e874">E</font>-<font color="#74e874">F</font>ile<font color="#74e874"> S</font>ystem</a>
...
<div class="card">
 <div id="loader"></div>
    ...
    <div class="card-body">
        ...
        <form action="admin_reset.php" method="POST">
            <p class="h4 text-center py-4">Reset Password</p>
           ...
           <div>
           <button class="btn btn-secondary"><a href="index.html" class="text-light">Back to Admin Page</a></button>

           </div>
            <div class="text-center py-4 mt-3">
                <button class="btn btn-warning btn-lg btn-block" name = "reset" id="login" type="submit">Reset Password</button>
            </div>
...
<!-- Card --></div>
       <footer class="text-center py-4 mt-3" style="background-color: rgb(206, 209, 154);margin-left: 30%;margin-right: 30%;border-radius:4px;    margin-bottom: 5px;">
                <p><?php echo date('Y');?> Created By:Md.Monarul Islam</p>
            </footer>
<!-- Card -->
  <!-- /Start your project here-->
