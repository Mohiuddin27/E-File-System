 ...
 $id=$_GET['id'];
   ...
   if(isset($_POST['save'])){
        ...
        $admin_comment=$_POST['admin_comment'];
			...
			$conn->query("UPDATE `user_file_upload` SET `admin_comment` = '$admin_comment' WHERE `id` = '$id'") or die(mysqli_error());
			echo '
				<script type = "text/javascript">
					alert("Your comment has been added");window.location = "user_uploaded_file.php";
				</script>
			';
...
<h5 class="card-header info-color white-text text-center py-4">
  <strong>Add Comment about user uploaded file</strong>
  </h5>
        ...
        <form  method="post" enctype="multipart/form-data" >
          <div class="col-md-11">
              ...
              <div>
               ...
               <textarea rows="4" cols="20" name="admin_comment" required></textarea>
              </div>
            </div>
