 ...
 <?php 
      ...
      $query = mysqli_query($conn,"SELECT * FROM upload_files WHERE DEPARTMENT LIKE 'cse'") or die (mysqli_error($con));
 ...
 <div class="col-md-12">
      ...
      <?php
        ...
        while($file=mysqli_fetch_array($query)){
          $id =  $file['id'];
          $department_name=  $file['name'];
       ?>
    <div class="col-md-3 mb-4">

      <div>
        <h6 style="text-transform:uppercase"><i class="fas fa-chalkboard-teacher"> <?php  echo $department_name;  ?></i></h6>
        <?php 
              $query_dep = mysqli_query($conn,"SELECT * FROM upload_files WHERE DEPARTMENT='$department_name'") or die (mysqli_error($con));
              while($file=mysqli_fetch_array($query_dep)){
                $id =  $file['ID'];
                $name =  $file['NAME'];
                $size =  $file['SIZE'];
                $uploads =  $file['EMAIL'];
            ...
            ?>
              <a href='downloads.php?file_id=<?php echo $id; ?>' class="list-group-item list-group-item-action waves-effect"><?php echo $name;  ?></a>
              <?php 
              }
              ?>
        </div>
