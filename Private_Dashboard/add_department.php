      ...
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <div class="d-flex justify-content-center pull-right">
            ...
            <button class="btn btn-warning"><i class="far fa-file-image"></i>  View Department</button></a>
        </div>
      </div>
      <hr>
    <div class="modal fade" id="modalRegisterForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
...
<h5 class="card-header info-color white-text text-center py-4">
  ...
  <div class="card-body px-lg-5 pt-0">
    ...
    <div class="container">
     ...
     {
        $name_dep=$_POST['name'];
        $name=strtolower($name_dep);
        $conn->query("INSERT INTO `departments` VALUES('','$name')") or die(mysqli_error());
			echo '
				<script type = "text/javascript">
					alert("Department has been added");window.location = "view_department.php";
				</script>
			';
     } 
      ?>
        <form action="" method="post">
          ...
          <button  type="submit" class="btn btn-info btn-rounded btn-sm w-50 btn-block mx-auto my-4 waves-effect z-depth-0"  name="save" type="submit">ADD</button>
        </form>
      </div>
    </div>
  </div>
