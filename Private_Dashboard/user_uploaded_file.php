...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT * FROM user_file_upload") or die (mysqli_error($con));
      while($file=mysqli_fetch_array($query)){
        $id=$file['id'];
         $file_name =  $file['files'];
         $username =  $file['username'];
         $user_email =  $file['user_email'];
         $user_department=$file['user_department'];
         
    
      ?>
     
      <td width="20%"><?php echo  $file_name; ?></td>
      ...
      <!-- <td><?php echo $download; ?></td> -->
           ...
           <td><a href='userdownloads.php?file_id=<?php echo $id; ?>'  class="btn btn-sm btn-outline-primary"><i class="fa fa-download"></i></a></td>
           <td><a href='adduserfilecomment.php?id=<?php echo $id; ?>' class="btn btn-info btn-sm">Add your comment</a></td>
    </tr>
<?php } ?>
</tbody>
   </table>
