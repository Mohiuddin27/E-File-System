...
<div class="container">
  ...
  <div class="row">
     ...
     <form action="user_fileprocess.php" method="post" enctype="multipart/form-data" >
           <label for="subject" class="">Upload File</label><br>
...
<tbody>
    ...
    <tr>
      ...
      $i=1;
      $query = mysqli_query($conn,"SELECT * FROM user_file_upload where user_email = '$email'") or die (mysqli_error($conn));
      while($file=mysqli_fetch_array($query)){
        $file_name=$file['files'];
        $admin_comment=$file['admin_comment'];
    
      ?>
     
      <td><?php echo $i;$i++; ?></td>
      <td><?php echo $file_name; ?></td>
      <td><?php echo $admin_comment; ?></td>
    </tr>
<?php } ?>
</tbody>
   </table>
