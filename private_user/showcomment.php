...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark default-color fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item" ><a href="home.php" class="text-light mt-2">HOME</a></li>
      <li class="nav-item dropdown">
        <a style="text-transform:capitalize"class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-4" data-toggle="dropdown"
          aria-haspopup="true" aria-expanded="false">
           <font color="black"><i class="fas fa-sign-in-alt"></i> Login </a>
...
<tbody>
    ...
    <tr>
      ...
      $user_id=$_SESSION['id'];
    //   echo $user_id;
      $query = mysqli_query($conn,"SELECT * FROM comments where user_id='$user_id' ORDER BY id DESC") or die (mysqli_error($conn));
      $i=1;
      while($file=mysqli_fetch_array($query)){
         $id=$file['id'];
         $my_comment =  $file['user_comment'];
         $admin_reply =  $file['admin_reply'];
      ...
      <td>
      <a class="btn btn-danger btn-sm test-light"href="comment_delete.php?delete_id=<?php echo $id; ?>">DELETE</a>
      </td>
...
<?php } ?>
 ...
 <div class="col-md-3" style="border-top: 4px solid #17a2b8;border-radius: 4px;  box-shadow: 0px 1px 1px 0px  #6c757d;"><br>
  ...
  <li class="nav-item">
    <a class="nav-link" id="pills-contact-tab"  href="" role="tab"
...
<div class="tab-content pt-2 pl-1" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    <img style="width:150px;height:100px;objecct-fit:cover" src="https://img.freepik.com/premium-vector/young-man-avatar-character-vector-illustration-design_24877-18516.jpg?w=2000" class="rounded" alt="..."><hr>
    <div class="">
